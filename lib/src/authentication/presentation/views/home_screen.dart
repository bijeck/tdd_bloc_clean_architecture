...
import 'package:tdd_bloc_clean_architecture/src/authentication/presentation/widgets/create_user_dialog.dart';
import 'package:tdd_bloc_clean_architecture/src/authentication/presentation/widgets/loading_column.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void getUsers() {
    context.read<AuthenticationBloc>().add(GetUsersEvent());
  }
